...
class CP_solver:
    def __init__(self, instance_number, timelimit, save_directory):
        ...
        # Optimal values for each instance as shown in the image
        self.optimal_values = {
            1: 14, 2: 226, 3: 12, 4: 220, 5: 206, 6: 322, 7: 167,
            8: 186, 9: 436, 10: 244, 11: 304, 12: 346, 13: 434,
            14: 589, 15: 567, 16: 286, 17: 1187, 18: 466, 19: 334,
            20: 1048, 21: 377
        }
    ...
    def solve(self):
        model_with_symmetry = minizinc.Model('models/CP_model(with SB).mzn')
        model_without_symmetry = minizinc.Model('models/CP_model(without SB).mzn')
        ...
        for model_name, model in [("with_symmetry", model_with_symmetry), ("without_symmetry", model_without_symmetry)]:
            ...
            for instance_name, instance in [("gecode", instance_gecode), ("chuffed", instance_chuffed)]:
                ...
                if result and result["obj"] is not None:
                    ...
                    expected_optimal = self.optimal_values.get(self.instance_number)
                    is_optimal = result["obj"] == expected_optimal
